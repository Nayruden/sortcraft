...
class FilterRuleFactory {
    public static FilterRule fromYaml(MinecraftServer server, String key, String value) {
        ...
        switch (key.toLowerCase()) {
            case "enchantment": return new EnchantmentFilterRule(value, registries.getOrThrow(RegistryKeys.ENCHANTMENT));
            // case "custom_name": return new CustomNameFilterRule(value);  break; // Implement
            // types of potions
            default:
